...
This directory houses all operating system's temporary files and
directory. Unlike `/tmp` base directory, this temporary directory
**get persisted** across reboot enabling post booting forensic
analytics use.
