...
The goal is to expand the OS' functionalities from minimum critical stage
to full catalogue stage.
...
base UNIX operating system's functionalities. When `/usr` combines with the
