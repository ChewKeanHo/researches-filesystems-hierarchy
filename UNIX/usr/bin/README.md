...
supplied non-critical programs and applications for extending the
operating system's functionalities from minimum critical stage to
...
and applications here. Otherwise, for any user-specific installed
programs and applications, you should use `/usr/local/bin` instead.
