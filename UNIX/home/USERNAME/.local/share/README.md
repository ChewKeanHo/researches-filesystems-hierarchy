...
user-specific CPU architecture independent data files (e.g. fonts, pdfs,
etc) for extending the operating system's functionalities from complete
stage to personalized stage. This means that data in this directory
only appears specifically for this user.
